        ...
        <div class="row">
            ...
            <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
                <div class="widget dashboard-container my-adslist">
                    <h3 class="widget-header"> Transaction History List </h3>
                    <table class="table table-responsive product-dashboard-table">
                        ...
                        <tbody>
                        <% if(transactionHistories != null) {for(TransactionHistory trHis : transactionHistories){%>
                        <tr>
                            <td class="product-thumb">
                                <img width="80px" height="auto" src="resources/images/products/products-1.jpg" alt="image description"></td>
                            <td class="product-details">
                                <span class="add-id"><strong>Name:</strong> <% out.print(trHis.getItem().getName()); %></span>
                                <span class="add-id"><strong>UPC:</strong> <% out.print(trHis.getItem().getUpc()); %> </span>
                                <span class="add-id"><strong>Price:</strong> <% out.print(trHis.getItem().getPrice()); %> </span>
                            </td>
                            <td class="product-category"><span class="categories"><% out.print(trHis.getUser().getName() + " " + trHis.getUser().getSurname()); %></span></td>
                            <td class="product-category"><span class="categories"><% out.print(trHis.getTransactionTime()); %></span></td>
                          </tr>
                        <% }}%>
                        </tbody>
                    </table>
