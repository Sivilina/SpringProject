    ...
    <div class="row">
      <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
        <div class="widget personal-info">
          <h3 class="widget-header user">Add Item</h3>
          ...
          <form:form action="/addItem" method="post" modelAttribute="item">
            ...
            <div class="form-group">
              <label for="last-name">Universal Product Code</label>
              <form:input path="upc" cssClass="form-control" required="required" id="last-name" />
            </div>
            <div class="form-group">
              <label for="last-name">Price</label>
              <form:input path="price" cssClass="form-control" required="required" id="last-name" />
            </div>
            <div class="form-group">
              <label for="current-password">Amounts</label>
              <form:input path="amounts" cssClass="form-control" required="required" id="current-password" />
            </div>
