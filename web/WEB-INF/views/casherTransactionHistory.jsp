...
<head>
    ...
    <title>Casher Transaction History</title>
    <!-- PLUGINS CSS STYLE -->
        ...
        <div class="row">
            <div class="col-md-10 offset-md-1 col-lg-4 offset-lg-0">
                <div class="sidebar">
                    ...
                    <div class="widget user-dashboard-menu">
                        <ul>
                            <li>
                                <a href="/casherHome"><i class="fa fa-user"></i> New transaction </a></li>
                            <li  class="active">
                                <a href="#"><i class="fa fa-file-archive-o"></i> Transaction History <span> <%if(transactionHistories != null) out.print(transactionHistories.size()); %></span></a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
                <div class="widget dashboard-container my-adslist">
                    <h3 class="widget-header">Transaction History</h3>
                    <table class="table table-responsive product-dashboard-table">
                        ...
                        <tbody>
                        <% if(transactionHistories != null) { for(TransactionHistory t: transactionHistories){%>
                        <tr>
                            <td class="product-thumb">
                                <img width="80px" height="auto" src="resources/images/products/products-1.jpg" alt="image description"></td>
                            <td class="product-details">
                            <span class="add-id"><strong>NAME:</strong> <% out.print(t.getItem().getName());%></span>
                                <span class="add-id"><strong>UPC:</strong> <% out.print(t.getItem().getUpc());%></span>
                                <span class="add-id"><strong>AMOUNT:</strong><% out.print(t.getAmount());%></span>
                                <span class="add-id"><strong>PRICE:</strong> <% out.print(t.getItem().getPrice());%></span>
                            </td>
                            <td class="product-category"><span class="categories"><% out.print(t.getUser().getName() + " " + t.getUser().getSurname());%></span></td>
                            <td class="product-category"><span class="categories"><% out.print(t.getTransactionTime());%></span></td>
                        </tr>
                        <% }}%>
                        </tbody>
                    </table>
