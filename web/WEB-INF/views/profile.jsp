        ...
        <div class="row">
            <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
                <div class="widget personal-info">
                    <h3 class="widget-header user">Register</h3>
                    <form:form id = "addUserForm" action="/editProfile" method="post" modelAttribute="user">
                        <form:input  type="hidden" path="id"/>
                        <div class="form-group">
                            <label for="first-name">Name</label>
                            <form:input path="name" cssClass="form-control" required="required" id="first-name"/>
                        </div>
                        <div class="form-group">
                            <label for="last-name">Surname</label>
                            <form:input path="surname" cssClass="form-control" required="required" id="last-name" />
                        </div>
                        <div class="form-group">
                            <label for="last-name">Login</label>
                            <form:input path="login" cssClass="form-control" required="required" id="last-name" />
                        </div>
                        <div class="form-group">
                            <label for="current-password">Password</label>
                            <form:input path="password" cssClass="form-control" required="required" id="current-password" />
                        </div>
                        <div class="form-group">
                            <label for="role">Role</label>
                            <form:select path="role.id" cssClass="<form action=" id="role">
                        ...
                        <button class="btn btn-transparent">Register</button>
                    </form:form>
                </div>
            </div>
        </div>
