        ...
        <div class="row">
            <div class="col-md-10 offset-md-1 col-lg-4 offset-lg-0">
                <div class="sidebar">
                    ...
                    <div class="widget user-dashboard-menu">
                        <ul>
                            <li class="active">
                                <a href="#"><i class="fa fa-user"></i> New transaction </a></li>
                            <li>
                                <a href="/transactionHistoryCasher"><i class="fa fa-file-archive-o"></i> Transaction History <span> <% if(transactionHistories != null) out.print(transactionHistories.size()); %></span></a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
                <div class="widget dashboard-container my-adslist">
                    <h3 class="widget-header">Universal product code</h3>
                    <form action="/addProduct" method="post">
                        <div class="form-group">
                            <input type="text" class="form-control" name="uniProductCode">
                        </div>
                        <button class="btn btn-transparent">Add</button>
                    </form>
                    <p><% if(request.getAttribute("error")!= null) out.print(request.getAttribute("error"));%></p>
                    <form action="/submitSelling" method="post">
                    <table class="table table-responsive product-dashboard-table">
                        <% ArrayList<Item> chosenItems = (ArrayList<Item>) request.getAttribute("chosenItemList");%>
                        <thead>
                        <tr>
                            <th>Image</th>
                            <th>Product Title</th>
                        ...
                        <tbody>
                        <% if(chosenItems != null) { for(Item item : chosenItems){ %>
                        <tr>
                            <td class="product-thumb">
                                <img width="80px" height="auto" src="resources/images/products/products-1.jpg" alt="image description"></td>
                            <td class="product-details">
                                <span class="add-id"><strong>Name:</strong> <% out.print(item.getName()); %></span>
                                <span class="add-id"><strong>UPC:</strong> <% out.print(item.getUpc()); %></span>
                            </td>
                            <td class="product-category"><span class="categories"><% out.print(item.getPrice()); %></span></td>
                            <td class="product-category"><span class="categories"><% out.print(item.getAmounts()); %></span></td>
                        </tr>
                        <% }}%>
                        </tbody>
                    </table>
                        <% session.setAttribute("chosenItemList", chosenItems);%>
                    <button class="btn btn-transparent">Submit selling</button>
                    </form>
                </div>
            </div>
        </div>
