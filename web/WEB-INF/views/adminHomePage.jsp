        ...
        <div class="row">
            <div class="col-md-10 offset-md-1 col-lg-4 offset-lg-0">
                <div class="sidebar">
                    ...
                    <div class="widget user-dashboard-menu">
                        <ul>
                            <li class="active">
                                <a href="#"><i class="fa fa-bookmark-o"></i> Items <span> <% if(itemList != null) out.print(itemList.size()); %></span></a></li>
                            <li>
            ...
            <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
                <div class="widget dashboard-container my-adslist">
                    ...
                    <a class="edit" title="Add Item" href="/addItem">
                        ...
                        <tbody>
                        <% if(itemList != null) {for(Item item : itemList){%>
                        <tr>
                                ...
                                <div class="">
                                    <ul class="list-inline justify-content-center">
                                        <li class="list-inline-item">
                                            <a class="edit" href="/editItem?id= <% out.print(item.getId() + "\">"); %>
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a class="delete" href="/deleteItem?id= <% out.print(item.getId() + "\">"); %>
